...
class Plfs : public fusexx::fuse<Plfs>
{
    public:
        ...
        static int f_ftruncate (const char *, off_t, struct fuse_file_info *, Plfs_open_opt *);
        ...
        static int f_truncate( const char *path, off_t offset, Plfs_open_opt * );
    ...
    private:
        ...
        static int makePlfsFile( string, mode_t, int, Plfs_open_opt * );
        ...
        static int getattr_helper(string,const char *,struct stat *,Plfs_fd *, Plfs_open_opt *);
